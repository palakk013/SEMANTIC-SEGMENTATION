...
Description:
This script trains a semantic segmentation model using the Duality AI Falcon synthetic dataset.
...
def main():
    ...
    # ADD THESE LINES HERE (inside main function)
...
# FIXED
    ...
    assert os.path.exists(data_dir), f"Train dir not found: {data_dir}"
    assert os.path.exists(val_dir),  f"Val dir not found: {val_dir}"
    print("✅ Paths verified:", data_dir)
    # Create datasets
